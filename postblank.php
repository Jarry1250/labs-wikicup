...
$linestarts = array_values(array('FA' => '\#', 'GA' => '\#', 'FL' => '\#', 'FP' => '\#', 'FS' => '\#', 'FPO' => '\#', 'FT' => '\#\#', 'GT' => '\#\#', 'DYK' => '\#', 'ITN' => '\#', 'GAR' => '\#'));
...
$year = 2013;
$judges = array( "J Milburn" ); //Who blanks the pages?
...
$points_page_name = 'User:Jarry1250/WC';
...
foreach( $contestants as $contestant ) {
	...
	$history = $page->history( 30 );
	do {
		$item = array_shift( $history );
	} while( !in_array( $item['user'], $judges ) && count( $history ) > 0 );
	$preblank = $page->history( 1, "older", true, $item['parentid'] );
